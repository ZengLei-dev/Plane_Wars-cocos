...
bool HelloWorld::init()
{
	...
	gameItem->setPosition(Point(origin.x + visibleSize.width / 2 - closeItem->getContentSize().width / 2, 150));
	helpItem->setPosition(Point(origin.x + visibleSize.width / 2 - closeItem->getContentSize().width / 2, 100));
	gameItem->setColor(Color3B::RED);
    ...
    auto menu = Menu::create(closeItem,gameItem,helpItem, NULL);
...
void HelloWorld::menuCloseCallback(Ref* pSender)
{
	...
	case 11://game
		Director::getInstance()->replaceScene(TransitionFlipX::create(0.2, CGameScene::creatScene()));
		break;
	case 12://help
		Director::getInstance()->replaceScene(TransitionFlipX::create(0.2, CHelpScene::creatScene()));
		break;
